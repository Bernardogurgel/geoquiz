...
let img1;
function preload() {
imgmenu = loadImage('capajogo.png');
...
imgpergunta8 = loadImage('perguntaoito.png');
imgpergunta9 = loadImage('perguntanove.png');
imgpergunta10 = loadImage('pergunta10.png');
imginstrucoes = loadImage('instrucoes.png');
imgcreditos = loadImage('fundocreditos.png');
imgfalhou = loadImage('falhou.png');
imgparabens = loadImage('fundoparabens.png');
}
...
function pergunta1() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) França e Espanha.',50,200)
  text('b) Alemanha e Suécia.',50,280)
  text('c) Reino Unido e França.',50,360)
  text('d) Portugal e Espanha.',50,440)
}
...
function pergunta2() {
  ...
  fill("#000000");
  textSize(20);
  text('a) União Europeia.',50,200)
  text('b) Euro',50,280)
  text('c) APEC - Cooperação Economica da Ásia e do Pacifico',50,360)
  text('d) Comunidade dos Estados Indepentes (CEI)',50,440)
}
...
function pergunta3() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) na mera localização geográfica dos países.',50,200)
  text('b) na influência cultural europeia.',50,280)
  text('c) no meridiano de Greenwich.',50,360)
  text('d) na adoção de um sistema político socialista.',50,440)
}
...
function pergunta4() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) Portugal e Holanda',50,200)
  text('b) Holanda e Alemanha',50,280)
  text('c) Inglaterra e França',50,360)
  text('d) Portugal e Espanha',50,440)
}
...
function pergunta5() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) a busca por novas rotas ultramarinas',50, 200)
  text('b) a substituição de especiarias por sal marino',50,280)
  text('c) o tráfico de escravos africanos',50,360)
  text('d) a produção de tecidos nas colônias',50,440)
}
...
function pergunta6() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) Povoar o continente americano.',50,200)
  text('b) Testar novos instrumentos de navegação.',50,280)
  text('c) Descobrir uma nova rota comercial para as índias.',50,360)
  text('d) Conhecer a costa africana para atualização dos mapas.',50,440)
}
...
function pergunta7() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) liberal',50,200)
  text('b) industrial',50,280)
  text('c) mercantil',50,360)
  text('d) informacional',50,440)
}
...
function pergunta8() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) das moradias',50,200)
  text('b) da religião',50,280)
  text('c) das vestimentas',50,360)
  text('d) do desmatamento',50,440)
}
...
function pergunta9() {
  ...
  stroke("#000000")
  fill("#000000")
  text('a) Tundra, Taiga e Floresta Temperada',50,200)
  text('b) Conífera, Tundra e Savana.',50,280)
  text('c) Pradaria, Tundra e Taiga.',50,360)
  text('d) Tundra, Pradaria e Savana',50,440)
}
...
// link do video: https://youtu.be/dMxQ-3KBe7A